...
Thanks for your interest in contributing. Career-Ops is built for Codex and Bun-first local workflows.
...
- Keep modes language-agnostic when possible (the shared agent flow handles both EN and ES)
