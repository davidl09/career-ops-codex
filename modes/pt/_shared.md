...
- Abaixo de 3.5 → Recomendado nao aplicar (veja Ethical Use no AGENTS.md)
...
1b. **Na primeira avaliacao de cada sessao:** Executar `bun cv-sync-check.mjs` via Bash. Se houver avisos, informar o candidato antes de continuar
