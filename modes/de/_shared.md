...
1b. **Bei der ersten Bewertung jeder Session:** `bun cv-sync-check.mjs` per Bash ausführen. Bei Warnungen den Kandidaten informieren, bevor weitergearbeitet wird
